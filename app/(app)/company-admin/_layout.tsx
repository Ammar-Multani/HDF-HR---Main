...
const navigationItems: NavItemType[] = [
  { icon: 'home', label: 'Dashboard', path: '/company-admin' },
  { icon: 'account-group', label: 'Employees', path: '/company-admin/employees' },
  { icon: 'clipboard-text', label: 'Tasks', path: '/company-admin/tasks' },
  { icon: 'file-document', label: 'Forms', path: '/company-admin/forms' },
  { icon: 'receipt', label: 'Receipts', path: '/company-admin/receipts' },
  { icon: 'account-circle', label: 'Profile', path: '/company-admin/profile' },
];
