...
const CreateCompanyScreen = () => {
  ...
  const { control, handleSubmit, formState: { errors }, reset, watch } = useForm<CompanyFormData>({
    defaultValues: {
      company_name: '',
      registration_number: '',
      industry_type: '',
  ...
  const onSubmit = async (data: CompanyFormData) => {
    try {
      ...
      const { error: companyUserError } = await supabase.from('company_user').insert([
        {
      ...
      setSnackbarMessage('Company created successfully and invitation sent to admin');
      setSnackbarVisible(true);
      ...
      >
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
          ...
          <Text style={styles.helperText}>
            An invitation will be sent to this email to set up the company admin account.
          </Text>
